...
class Process extends CI_Controller {
	...
	public function hibah($tp, $dx=0)
	{
		...
		switch($tp){
			...
			if($name && $address && $judul && $latar && $maksud){
				...
				if(isset($_POST['tanggal'])) $this->db->insert("proposal", array('user_id' => $user_id, 'name' => $name, 'judul' => $judul, 'latar_belakang' => $latar, 'maksud_tujuan' => $maksud, 'address' => $address, 'file' => $new_file_name, 'time_entry' => $_POST['tanggal'], 'skpd_id' => $skpd_id));
	...
	public function generate_dnc($kategori=0, $dari='', $sampai='', $skpd=0)
	{
        ...
        <body>
			...
			<p align="right">BUPATI BANDUNG,<br><br><br><br>Drs. H. Abubakar, M.Si</p>
