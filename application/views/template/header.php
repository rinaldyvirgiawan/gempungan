    ...
    <div class="wrapper">
        ...
        <nav role="navigation" class="nav-main">
            <ul class="clearfix list-nostyle">
                <li>
                    <a class="link-green" href="<?php echo site_url('tentang') ?>">Tentang </a>
                </li>
                <li>
                ...
                if(isset($_SESSION['sabilulungan']['role'])){
                    ...
                    elseif($_SESSION['sabilulungan']['role']==3) echo '<li><a class="link-purple" href="'.site_url('report').'">Pemberian Rekomendasi</a></li><li><a class="link-purple" href="'.site_url('hibah').'">Daftar</a></li> ';
        ...
        <!-- nav-main -->
        <div class="nav-user list-nostyle clearfix" style="margin-top:-0.5em;">
            ...
            <a class="logo-bandung" style="width:70px;" target="_blank" href="http://bandungbaratkab.go.id/">
                <img style="margin-left:1em;" src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/57/Kab_Bandung_Barat.svg/1078px-Kab_Bandung_Barat.svg.png" alt="" height="50" width="100">
            </a>
            <?php
            if(isset($_SESSION['sabilulungan']['role'])){
