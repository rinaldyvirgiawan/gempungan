...
<div class="wrapper clearfix">
    ...
    <div class="widget-side">
        ...
        <ul class="category-list list-nostyle">
            ...
            <li><a href="<?php echo site_url('cms/tentang'); ?>">Tentang Gempungan</a></li> 
...
<div class="primary">            
    ...
    <div class="project-detail-wrapper">
        ...
        <table class="table-global">
            ...
            <tbody>
                <?php
                $Qlist = $this->db->query("SELECT pengumuman_id, judul FROM pengumuman ORDER BY pengumuman_id DESC LIMIT $position,$limit");
        ...
        <?php
        $Qpaging = $this->db->query("SELECT pengumuman_id, judul FROM pengumuman");
...
$Qedit = $this->db->query("SELECT * FROM pengumuman WHERE `pengumuman_id`='$p'"); $edit = $Qedit->result_object();
?>
