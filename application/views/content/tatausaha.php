    ...
    <div class="wrapper-half">
        ...
        <form action="<?php echo site_url('process/tatausaha/periksa/'.$dx) ?>" method="post" class="form-check form-global">
            ...
            <div class="control-actions">
                ...
                <input type="submit" name="lanjut" class="btn-red btn-plain btn" style="display:inline" value="Lanjut ke Pemeriksaan oleh Bupati" />
            ...
            <ul class="category-list list-nostyle">
                ...
                foreach($Qlist1->result_object() as $list1){
                    echo '<li>
                            <label class="checkbox">
                                <input type="checkbox" name="kelengkapan[]" value="'.$list1->id.'"';
                                foreach($Qedit1->result_object() as $edit1) if($edit1->checklist_id==$list1->id) echo ' checked';
                                echo '>'.$list1->name.'
                            </label>
                        </li>';                    
                }
            ...
            <ul class="category-list list-nostyle">
                ...
                foreach($Qlist2->result_object() as $list2){
                    echo '<li>
                            <label class="checkbox">
                                <input type="checkbox" name="persyaratan[]" value="'.$list2->id.'"';
                                foreach($Qedit1->result_object() as $edit1) if($edit1->checklist_id==$list2->id) echo ' checked';
                                echo '>'.$list2->name.'
                            </label>
                        </li>';
                }
