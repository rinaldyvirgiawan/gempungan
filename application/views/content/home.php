	...
	<!-- Indicators -->
		...
		<!--<div class="carousel-inner">
			<div class="item active">
			  <img src="<?php echo base_url('media/cms/'.$edit[1]->content) ?>" alt="Los Angeles">
			</div>
			<div class="item">
			  <img src="<?php echo base_url('media/cms/'.$edit[1]->content) ?>" alt="Chicago">
			</div>
			<div class="item">
			  <img src="<?php echo base_url('media/cms/'.$edit[0]->content) ?>" alt="New York">
			</div>
		</div>
