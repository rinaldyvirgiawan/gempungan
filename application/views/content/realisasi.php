...
?>
    ...
    <div class="project-detail-wrapper">
        ...
        if($Qpaging->num_rows > $limit){
            $this->ifunction->paging($p, site_url('realisasi').'/'.$tp.'/', $num_page, $Qpaging->num_rows, 'href', false);
        }
        ?>             
    </div>
...
$Qedit = $this->db->query("SELECT * FROM laporan WHERE `laporan_id`='$p'"); $edit = $Qedit->result_object();
?>
