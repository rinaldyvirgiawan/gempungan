    ...
    <div class="wrapper-half">
        ...
        <form action="<?php echo site_url('process/pertimbangan/verifikasi/'.$dx) ?>" method="post" class="form-check form-global">
            ...
            <div class="control-actions">
                ...
                $view = base_url('index.php/process/report_bansos/'.$dx);
                $export = base_url('index.php/process/pdf/export/'.date('d-M-Y').' - '.rawurlencode($detail[0]->judul).'/'.$detail[0]->type_id.'/'.$dx);                
                ?>
