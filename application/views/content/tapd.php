    ...
    <div class="wrapper">
        ...
        <div class="form-global">
            ...
            <div class="control-actions">
                ...
                <?php
                if(isset($_POST['rekap'])) echo '<a target="_blank" href="'.base_url('index.php/process/generate_dnc/'.$_POST['kategori'].'/'.$_POST['dari'].'/'.$_POST['sampai'].'/'.$_POST['skpd']).'" class="btn-red btn-plain btn" style="display:inline">Cetak DNC PBH</a>';
                else echo '<a target="_blank" href="'.base_url('index.php/process/generate_dnc/'.$_POST['kategori'].'/'.$_POST['dari'].'/'.$_POST['sampai'].'/'.$_POST['skpd']).'" class="btn-red btn-plain btn" style="display:inline">Cetak DNC PBH</a>';
                ?>
                <a href="<?php echo site_url('report') ?>" class="btn-grey btn-plain btn" style="display:inline">Kembali</a>
            </div>
        </div>
