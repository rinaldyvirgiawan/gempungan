...
function Image($file,$x,$y,$w=0,$h=0,$type='',$link='',$paint=true)
{
	...
	if(!isset($this->images[$file]))
	{
		...
		if(get_magic_quotes_runtime()) set_magic_quotes_runtime(false);//set_magic_quotes_runtime(0);
		...
		if(get_magic_quotes_runtime()) set_magic_quotes_runtime(false);//set_magic_quotes_runtime($mqr);
